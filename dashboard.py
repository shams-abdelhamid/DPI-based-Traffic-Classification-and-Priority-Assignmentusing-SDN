...
#Devices connected
canvas.create_text(300, 150, text="Devices Connected", fill = "black", font = ("Times New Roman", 17))
...
#Speedometer
canvas.create_text(275, 400, text="Speedometer", fill = "black", font = ("Times New Roman", 17))
...
internetSpeed.place(relx = 0.2, rely = 0.57)
